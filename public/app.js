const $=s=>document.querySelector(s), all=s=>[...document.querySelectorAll(s)]; let token=localStorage.token||'', user=null, structureType='faculty', cache={structure:[],analyticsStructures:[]}, effectivePermissions=[], socket=null, activeLessonId='';
...
$('#refreshReports').onclick=loadReports;$('#reportDays').onchange=loadReports;let auditTimer;$('#auditSearch').oninput=function(){clearTimeout(auditTimer);auditTimer=setTimeout(loadReports,400)};
